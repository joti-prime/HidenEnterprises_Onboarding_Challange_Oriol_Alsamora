...
@php
    // Ads / AdSense removed for HCTestDash (onboarding challenge build).
    $showAds = false;
    $adsCanonicalRoot = false;
@endphp
...
<head>
    ...
    <title>@yield('title') - @settings('app_name', 'HCTestDash')</title>
    <link rel="icon" href="@settings('favicon', '/assets/core/img/favicon.png')">
    ...
    <meta property="og:title" content="{{ trim($__env->yieldContent('title')) }} - @settings('seo::title', 'HCTestDash')">
