...
<head>
    <title>@settings('seo::title', 'HCTestDash')</title>
    <link rel="icon" type="image/png" href="@settings('favicon', '/assets/core/img/favicon.png')">
    ...
    <meta property="og:title" content="@settings('seo::title', 'HCTestDash')">
        ...
        <div class="mx-auto max-w-screen-xl px-4 py-8 sm:py-16 lg:px-6">
            <div class="mb-8 max-w-screen-md lg:mb-16">
                ...
                <p class="text-gray-500 dark:text-gray-400 sm:text-xl">
                    {!! __('client.our_game_anel_desc', ['app' => settings('app_name', 'HCTestDash')]) !!}
                </p>
            </div>
                ...
                <div class="mb-6 md:mb-0">
                    <a href="/" class="flex items-center">
                        <img src="@settings('logo', '/assets/core/img/logo.png')" class="mr-3 h-8"
                            alt="@settings('app_name', 'HCTestDash') Logo" />
