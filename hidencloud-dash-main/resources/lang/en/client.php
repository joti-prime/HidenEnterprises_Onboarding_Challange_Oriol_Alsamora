...
return [
    ...
    'upgrade_server_resources' => 'Upgrade Server Resources',
    'upgrade_resources' => 'Upgrade Resources',
    'how_it_works' => 'How it works',
    'pay_the_difference_and_changes_apply_immediately' => 'Pay the difference and changes apply immediately',
    'apply_immediately_without_refund' => 'Apply immediately without refund',
    'current_monthly_cost' => 'Current monthly cost',
    'new_monthly_cost' => 'New monthly cost',
    'price_difference' => 'Price difference',
    'payment_method' => 'Payment Method',
    'select_payment_method' => 'Select payment method',
    'apply_changes' => 'Apply Changes',
    'pay_upgrade' => 'Pay Upgrade',
    'apply_downgrade' => 'Apply Downgrade',
    ...
    'max' => 'Max',
    'month' => 'month',
    'configurable_options_have_been_downgraded_successfully' => 'Configurable options have been downgraded successfully',
    ...
    'whatsapp_link_sent' => 'Verification code sent to :phone. Check your WhatsApp and type the code below.',
    'whatsapp_link_verified' => 'WhatsApp account linked to :phone.',
    'whatsapp_link_rate_limited' => 'You requested too many verification codes recently (max :n / hour). Please try again later.',
    'whatsapp_link_cooldown' => 'You can request a new code in :minutes min.',
    'whatsapp_link_phone_in_use' => 'That number is already linked to another HidenCloud account.',
    'whatsapp_link_removed' => 'WhatsApp account unlinked.',
    'whatsapp_link_code_invalid' => 'That code is not valid. Double-check the 6 digits and try again.',
    'whatsapp_link_code_expired' => 'The code has expired or there is no pending verification. Start over.',
    'whatsapp_link_too_many_attempts' => 'Too many failed attempts. Request a new code.',
    'enable' => 'Enable',
    'disable' => 'Disable',
    'download' => 'Download',
    'sessions' => 'Sessions',
    ...
    'hello' => 'Hello',
    'email_template_content' => 'Should you have any further inquiries or require ongoing support, please feel free to reach out to us through our online portal. Our dedicated team is available to assist you promptly and efficiently via the ticketing system. Do not reply to this email. If you need help, please contact us: https://docs.hidencloud.com/information/contact',
    'regards' => 'Regards',
    ...
    'base_package_price' => 'Base Package Price',
    'total_price' => 'Total Price',

    'cloudy_ai_title' => 'Cloudy AI: your server assistant',
    'cloudy_ai_description' => 'Your plan includes <strong>Cloudy AI</strong>, an intelligent assistant that can diagnose crashes, install plugins, optimize performance and manage your server. Look for the AI Assistant button in your control panel.',
    'console_quick_view_title' => 'This console is a quick view, not the full server panel.',
    'console_quick_view_description' => 'For full management (files, plugins, backups, configuration, SFTP, etc.) open the panel directly with the :button button on your service page.',
    'cloudy_ai_more_info' => 'More info',

    'free_service_modal_title' => 'Heads up: free service detected on your account',
    'free_service_modal_intro' => 'You have at least one free service on your account. Support for free services is limited to billing and account-related issues.',
    'free_service_modal_scope_heading' => 'We provide hosting, not configuration.',
    'free_service_modal_scope_body' => 'We rent you the server itself. Everything you run inside it (game files, plugins, mods, settings, custom code, etc.) is entirely your responsibility. Only open a ticket if you are 100% sure the problem is on our hosting side: the server will not start due to our infrastructure, network outages, billing, account access, and similar.',
    'free_service_modal_not_covered_heading' => 'We do NOT provide support for:',
    'free_service_modal_not_covered_config' => 'Server configuration errors',
    'free_service_modal_not_covered_plugins' => 'Installing or troubleshooting plugins, mods, or any custom content',
    'free_service_modal_not_covered_tuning' => 'Performance tuning or anything related to your server setup',
    'free_service_modal_resources' => 'For those topics please check our resources first: our <a href="https://www.youtube.com/@hiden_cloud" target="_blank" rel="noopener noreferrer" class="font-medium text-primary-600 hover:underline dark:text-primary-500">YouTube channel</a>, <a href="https://www.hidencloud.com/cloudy-ai" target="_blank" rel="noopener noreferrer" class="font-medium text-primary-600 hover:underline dark:text-primary-500">Cloudy AI</a> inside your panel, and our <a href="https://docs.hidencloud.com" target="_blank" rel="noopener noreferrer" class="font-medium text-primary-600 hover:underline dark:text-primary-500">documentation</a>.',
    'free_service_modal_closure_notice' => 'Tickets opened about unsupported topics on a free service will be closed without a response.',
    'free_service_modal_covered_topics' => 'If your ticket is about billing, account access, or another covered topic, you can continue.',
    'free_service_modal_paid_exception' => 'Note: this notice only applies to free services. If your ticket is about one of your paid services, please ignore it and continue.',
    'ticket_new_response_subject' => 'New Response [:subject]',
    'ticket_new_response_content' => 'Your ticket received a new response. Please click the button below to view your ticket.',
    'ticket_new_response_label_response' => 'Support Response',
    'ticket_new_response_button' => 'View Ticket',
    'ticket_auto_close_inactive' => 'This ticket has been automatically closed because we did not receive a reply from you in the last :hours hours. If the issue persists, please open a new ticket and we will be happy to help.',
    'ticket_dept_gen_name' => 'General Questions',
    'ticket_dept_gen_description' => 'For general inquiries about our hosting services, plans, and features.',
    'ticket_dept_tech_name' => 'Technical Support',
    'ticket_dept_tech_description' => 'For help with technical issues, server problems, service upgrades, or connectivity concerns.',
    'ticket_dept_bill_name' => 'Billing Support',
    'ticket_dept_bill_description' => 'For questions related to invoices, payments, and other financial matters.',
    'ticket_dept_acc_name' => 'Account Support',
    'ticket_dept_acc_description' => 'For help with account setup, management, and updates.',
    'ticket_dept_extra_name' => 'Extra Services',
    'ticket_dept_extra_description' => 'For assistance with additional or extra services.',
    'ticket_dept_other_name' => 'Other Support',
    'ticket_dept_other_description' => 'For all other queries that do not fit into the categories above.',
    'ticket_message_min_length' => 'Please write at least 10 characters in the comment so we can understand your request.',
    'free_service_modal_continue' => 'I understand, continue',
    'free_service_modal_cancel' => 'Cancel',
];
