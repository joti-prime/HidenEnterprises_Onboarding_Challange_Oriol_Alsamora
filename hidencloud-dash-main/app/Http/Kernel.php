...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        ...
        'web' => [
            ...
            \App\Http\Middleware\FilterHetrixBots::class,
            ...
            \App\Http\Middleware\UpdateChecker::class,
            \App\Http\Middleware\TrackAffiliate::class,
            \App\Http\Middleware\ForceTwoFa::class,
            \App\Http\Middleware\TwoFactorAuthentication::class,
            \App\Http\Middleware\Punishments::class,
            \App\Http\Middleware\LogUserIpMiddleware::class,
            \App\Http\Middleware\UpdateLastSeen::class,
            \App\Http\Middleware\Maintenance::class,
            \App\Http\Middleware\RequireAddress::class,
            \App\Http\Middleware\CheckRevokedDevices::class,
            \App\Http\Middleware\CanViewOrder::class,
        ],
