@extends(AdminTheme::wrapper(), ['title' => __('admin.pages'), 'keywords' => 'HCTestDash Dashboard, HCTestDash Panel'])
            ...
            <div class="col-12 col-md-12 col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4>{!! __('admin.create_page', ['default' => 'Create Page']) !!}</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-4 col-12">
                                <div
                                    class="control-label">{!! __('admin.basic_page', ['default' => 'Basic Page']) !!}</div>
                                <label class="custom-switch mt-2">
                                    <input type="checkbox" name="basic_page" class="custom-switch-input" value="1">
                                    <span class="custom-switch-indicator"></span>
                                    <span class="custom-switch-description">
                            ...
                            <div class="form-group col-md-12 col-12">
                                ...
                                <input type="text" name="title" oninput="updatePath()" id="title"
                            ...
                            <div class="form-group col-md-12 col-12">
                                ...
                                <input type="text" name="icon" id="icon"
                                       ...
                                       value="<i class='bx bx-info-circle'></i>"
                                       required>
                                <small class="form-text text-muted">
                            ...
                            <div class="form-group col-md-12 col-12">
                                ...
                                <select
                                    ...
                                    <option
                                        value="portal">{!! __('admin.portal_navbar', ['default' => 'Portal Navbar']) !!}</option>
                                    <option value="navbar">{!! __('admin.navbar') !!}</option>
                                    <option
                                        value="footer_help_center">{!! __('admin.footer_help_center', ['default' => 'Help Center (footer)']) !!}</option>
                                    <option
                                        value="footer_resources">{!! __('admin.footer_resources', ['default' => 'Resources (footer)']) !!}</option>
                                    <option
                                        value="legal">{!! __('admin.footer_legal', ['default' => 'Legal (footer)']) !!}</option>
                                </select>
                                <small class="form-text text-muted">
                            ...
                            <div class="form-group col-md-2 col-12">
                                ...
                                <label class="custom-switch mt-2">
                                    ...
                                    <span class="custom-switch-indicator"></span>
                                    <span
                                        class="custom-switch-description">{!! __('admin.new_tab_redirect', ['default' => 'Redirect in a new tab']) !!}</span>
                                </label>
                            </div>

                            <div class="form-group col-md-10 col-12">
                                <label
                                    for="redirect">{!! __('admin.redirect_url', ['default' => 'Redirect URL']) !!}</label>
                                <input type="text" name="redirect" id="redirect"
                                       class="form-control @error('redirect') is-invalid @enderror" value=""
