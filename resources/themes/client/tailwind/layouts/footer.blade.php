    ...
    <form action="{{ route('balance.add') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <div class="relative mb-6 mt-6">
                ...
                <input type="number" id="amount" name="amount" step="1" min="3"
...
<footer class="bg-white p-4 dark:bg-gray-800 sm:p-6" style="margin-top: auto;">
    <div class="mx-auto max-w-screen-xl">
        <div class="md:flex md:justify-between">
            ...
            <a href="/" class="flex items-center">
                @if (Settings::has('logo'))
                    <img src="@settings('logo')" class="mr-3 w-20 h-20 rounded object-cover" alt="@settings('app_name', 'HCTestDash')" />
                @endif
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            ...
            <span class="text-sm text-gray-500 dark:text-gray-400 sm:text-center">
    Copyright © 2025 
    <a href="https://hidencloud.com" class="hover:underline" target="_blank" style="color: #EA580C;"><strong>HidenCloud™</strong></a> - All rights reserved. | E: 
    <a href="mailto:info@hidencloud.com" class="hover:underline">info@hidencloud.com</a> | T/WA: 
    <a href="https://wa.me/34930414115" class="hover:underline" target="_blank">+34 930 414 115</a>
</span>
            ...
            <div class="mt-4 flex space-x-6 sm:mt-0 sm:justify-center">
                ...
                @if (settings('socials::twitter'))
                    <a href="@settings('socials::twitter')" target="_blank"
                       class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                       <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="currentColor">
                        <title>X</title>
                ...
                <!-- YouTube -->
                <a href="https://www.youtube.com/@hiden_cloud" target="_blank"
                   class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                    <i class='bx bxl-youtube' style="font-size: 1.25rem"></i>
                </a>

                <!-- Instagram -->
                <a href="https://www.instagram.com/hiden_cloud/" target="_blank"
                   class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                    <i class='bx bxl-instagram' style="font-size: 1.25rem"></i>
                </a>

                <!-- TikTok -->
                <a href="https://www.tiktok.com/@hiden_cloud" target="_blank"
                   class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                    <i class='bx bxl-tiktok' style="font-size: 1.25rem"></i>
                </a>
            </div>
...
<script>
    async function copyToClipboard(button) {
        try {
            let textToCopy = button.getAttribute('data-copy-value') || button.textContent.trim();
            let originalText = button.textContent.trim();
