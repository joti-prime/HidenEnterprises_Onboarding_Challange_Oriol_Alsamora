    ...
    <div class="w-full">
        <div class="mb-8 flex items-center justify-center space-x-4 lg:hidden">
            <a href="#" class="flex items-center text-2xl font-semibold">
                ...
                <span class="text-gray-900 dark:text-white">@settings('app_name', 'HCTestDash')</span>
            </a>
        </div>
        ...
        <form method="POST" action="#">
            ...
            <div class="my-6 grid gap-5 sm:grid-cols-2">
                <div>
                    ...
                    <input type="password" name="password" id="password" placeholder="••••••••" oninput="validateRegisterPassword(this.value)"
                        class="focus:ring-primary-600 focus:border-primary-600 block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-gray-900 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 sm:text-sm"
                        required="">
            ...
            <!-- Password requirements feedback - Full width -->
            <div class="mt-4 mb-8">
                <div class="mb-3 text-sm font-normal text-gray-500 dark:text-gray-400">
                    {!! __('auth.password_recommended_requirements_desc') !!}:
                </div>
                <ul class="space-y-2 pl-4 text-gray-500 dark:text-gray-400">
                    <li id="register-length-requirement" class="text-sm font-normal flex items-center">
                        <span class="mr-2" id="register-length-icon">•</span>
                        {!! __('auth.password_recommended_requirements_chracters') !!}
                    </li>
                    <li id="register-lowercase-requirement" class="text-sm font-normal flex items-center">
                        <span class="mr-2" id="register-lowercase-icon">•</span>
                        {!! __('auth.at_least_lowercase_character') !!}
                    </li>
                    <li id="register-special-requirement" class="text-sm font-normal flex items-center">
                        <span class="mr-2" id="register-special-icon">•</span>
...
<script>
    ...
    function copyAndUse()
    {
        ...
        validateRegisterPassword(generatedPassword);

        // make the password field visible
        document.getElementById('password').type = 'text';
        document.getElementById('password_confirmation').type = 'text';
        
        // Hide password after a few seconds
        setTimeout(() => {
    ...
    function validateRegisterPassword(password) {
        const lengthReq = document.getElementById('register-length-requirement');
        const lowercaseReq = document.getElementById('register-lowercase-requirement');
        const specialReq = document.getElementById('register-special-requirement');
        
        const lengthIcon = document.getElementById('register-length-icon');
        const lowercaseIcon = document.getElementById('register-lowercase-icon');
        const specialIcon = document.getElementById('register-special-icon');
